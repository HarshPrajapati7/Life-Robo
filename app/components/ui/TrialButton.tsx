    ...
    <>
      <style>
        ...
        .shiny-custom-styles {
          ...
          --duration: 3s;
          --shadow-size: 2px;
          --trail-color: var(--user-trail-color, #4488ff);
          --blur-color: var(--user-blur-color, #66aaff);
      ...
      <button
        className="backdrop-blur-md !font-bold shiny-custom-styles isolate relative overflow-hidden cursor-pointer outline-offset-4 py-[0.5rem] px-[1.25rem] text-sm leading-tight !rounded-full text-blue-100 bg-[#0a1628] active:translate-y-px flex items-center justify-center"
        style={
          {
