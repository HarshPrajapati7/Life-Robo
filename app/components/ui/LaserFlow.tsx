...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    // Force initial size immediately and again after layout settles
    setSizeNow(true);
    requestAnimationFrame(() => setSizeNow(true));
    setTimeout(() => setSizeNow(true), 100);
    setTimeout(() => setSizeNow(true), 500);
    ...
    const adjustDprIfNeeded = (now: number) => {
      ...
      if (
        ...
        now - lastDprChangeTime > dprChangeCooldown
      ) {
